        ...
        <form method="post" action="options.php">
            ...
            <div class="haven-admin-card">
                ...
                <table class="form-table">
                    ...
                    <tr><th>Nome da empresa</th><td><input type="text" name="haven_cta_form_company_name" value="<?php echo esc_attr( haven_opt( 'haven_cta_form_company_name' ) ); ?>" class="regular-text"><p class="description">Esse nome aparece no topo do chat, como se fosse o contato oficial.</p></td></tr>
                    <tr>
                        <th>Avatar do atendimento</th>
                        <td>
                            <div class="haven-single-photo">
                                <input type="hidden" id="haven_cta_form_avatar" name="haven_cta_form_avatar" value="<?php echo esc_attr( haven_opt( 'haven_cta_form_avatar' ) ); ?>">
                                <?php if ( haven_opt( 'haven_cta_form_avatar' ) ) : ?>
                                    <img src="<?php echo esc_url( haven_opt( 'haven_cta_form_avatar' ) ); ?>" alt="Avatar do atendimento" style="max-width:96px;border-radius:50%;">
                                    <button type="button" class="button haven-remove-single" data-field="haven_cta_form_avatar">Remover</button>
                                <?php endif; ?>
                                <button type="button" class="button haven-upload-single" data-field="haven_cta_form_avatar">Selecionar avatar</button>
                                <p class="description">Envie uma imagem quadrada para representar a empresa no cabecalho do chat.</p>
                            </div>
                        </td>
                    </tr>
                </table>
