...
class HiJobs_Job_Short_Details_Widget extends Widget_Base {

	public function get_name() {
		return 'hijobs_job_short_details';
	}

	public function get_title() {
		return esc_html__( 'Job Short Details', 'hijobs-core' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'short_details',
			[
				'label' => esc_html__( 'Job Short Details', 'hijobs-core' ),
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'em' ],
                'selectors'  => [
                    '{{WRAPPER}} .job-short-details-wrapper' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
...
Plugin::instance()->widgets_manager->register( new HiJobs_Job_Short_Details_Widget );