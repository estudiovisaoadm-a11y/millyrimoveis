...
class HiJobs_Button_Widget extends Widget_Base {

	public function get_name() {

		return 'hijobs_button_widget';
	}

	public function get_title() {
		return esc_html__( 'Button', 'hijobs-core' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_tab(
			...
			[
				'label' => esc_html__('Normal', 'hijobs-core'),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .hijobs-button.hijobs-button-one' => 'background-color: {{VALUE}};',
				],
			]
		);

		$this->add_control(
			'btn_one_default_border',
			[
				'label'     => esc_html__('Border Color', 'hijobs-core'),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .hijobs-button.hijobs-button-one' => 'border-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .hijobs-button.hijobs-button-one:hover' => 'background-color: {{VALUE}};',
				],
			]
		);

		$this->add_control(
			'btn_one_hover_border',
			[
				'label'     => esc_html__('Border Color', 'hijobs-core'),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .hijobs-button.hijobs-button-one:hover' => 'border-color: {{VALUE}};',
				],
			]
		);
		...
		$this->start_controls_section(
			'button_two_option',
			[
				'label' => esc_html__( 'Button Two', 'hijobs-core' ),
				'tab'   => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .hijobs-button.hijobs-button-two' => 'background-color: {{VALUE}};border-color:{{VALUE}}',
				],
			]
		);

		$this->add_control(
			'btn_two_default_border',
			[
				'label'     => esc_html__('Border Color', 'hijobs-core'),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .hijobs-button.hijobs-button-two' => 'border-color:{{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} a.hijobs-button.hijobs-button-two,{{WRAPPER}} .ep-call-button' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .hijobs-button.hijobs-button-two:hover' => 'background-color: {{VALUE}};',
				],
			]
		);

		$this->add_control(
			'btn_two_hover_border',
			[
				'label'     => esc_html__('Border Color', 'hijobs-core'),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} a.hijobs-button.hijobs-button-two:hover,{{WRAPPER}} .ep-call-button:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'separator' => 'before',
				'selectors'  => [
					'{{WRAPPER}} .hijobs-button.hijobs-button-two' => 'Margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .ep-call-button' => 'Margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
	...
	protected function render() {
		...
		<div class="hijobs-button-wrapper ep-button-el-widget">
			<a href="<?php echo esc_url($btn_one_url);?>" class="hijobs-button ep-button hijobs-button-one" <?php echo esc_attr($btn_one_target . $btn_one_nofollow);?>><?php echo esc_html($btn_one_text);?>
			...
			<?php if($settings['btn_two_text']) :
				...
				?>
				<a href="<?php echo esc_url($btn_two_url);?>" class="hijobs-button ep-button hijobs-button-two" <?php echo esc_attr($btn_two_target . $btn_two_nofollow);?>><?php echo esc_html($btn_two_text);?>
                    <i class="fas fa-angle-double-right"></i>
                </a>
			<?php endif; ?>
		</div>
...
Plugin::instance()->widgets_manager->register( new HiJobs_Button_Widget );