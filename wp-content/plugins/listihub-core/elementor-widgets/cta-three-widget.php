...
class HiJobs_CTA_Three_Widget extends Widget_Base {

	public function get_name() {
		return 'hijobs_cta_three_widget';
	}

	public function get_title() {
		return esc_html__( 'CTA Three', 'hijobs-core' );
	}
	...
	protected function render() {
        ...
        $image_alt = get_post_meta( $settings['left_img']['id'], '_wp_attachment_image_alt', true );
        $image_title = get_the_title( $settings['left_img']['id']);
        $image_src = $settings['left_img']['url'];
		?>

		<div class="cta-area-wrapper cta-three-wrapper">
            <div class="cta-left-img">
                <img src="<?php echo esc_url($image_src);?>" alt="<?php echo esc_attr($image_alt);?>" title="<?php echo esc_attr($image_title);?>">
            </div>
			<div class="container">
				<div class="row">
					<div class="offset-xl-3 col-xl-5 col-lg-12">
					...
					<div class="col-xl-4  col-lg-12 my-auto">
...
Plugin::instance()->widgets_manager->register( new HiJobs_CTA_Three_Widget );