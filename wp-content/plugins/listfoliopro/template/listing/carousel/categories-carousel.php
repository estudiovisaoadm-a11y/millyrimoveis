<?php
	...
	wp_enqueue_script('slick', listfoliopro_ep_URLPATH.'admin/files/css/slick/slick.js', array('jquery'), $ver = true, true );
	wp_enqueue_style('slick', listfoliopro_ep_URLPATH . 'admin/files/css/slick/slick.css');
	wp_enqueue_style('slick-theme', listfoliopro_ep_URLPATH . 'admin/files/css/slick/slick-theme.css');
		...
		<?php
			...
			foreach ( $terms as $term_parent ) {
				if($term_parent->count>0){							
					$caticon= get_term_meta($term_parent->term_id, 'listfoliopro_term_icon', true);
					if($caticon==''){							
						$caticon="far fa-check-circle";
					}							
					$cat_link= get_term_link($term_parent , $listfoliopro_directory_url.'-category');
				?>
...
<?php
	wp_enqueue_script('listfoliopro_carousel_slick', listfoliopro_ep_URLPATH.'admin/files/js/carousel-slick.js', array('jquery'), $ver = true, true );
	wp_reset_query();
?>