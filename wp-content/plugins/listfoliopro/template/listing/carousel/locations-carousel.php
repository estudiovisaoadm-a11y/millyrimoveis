<?php
  ...
  wp_enqueue_style('listfoliopro_style-city', listfoliopro_ep_URLPATH . 'admin/files/css/styles.css');

wp_enqueue_script('slick', listfoliopro_ep_URLPATH.'admin/files/js/slick.js', array('jquery'), $ver = true, true );
wp_enqueue_style('slick', listfoliopro_ep_URLPATH . 'admin/files/css/slick.css');
					...
					foreach ( $terms as $term_parent ) {
						if($term_parent->count>0){
							...
							if($cate_main_image!=''){
								...
								$feature_img=listfoliopro_ep_URLPATH."/assets/images/default-directory.jpg";
							}
