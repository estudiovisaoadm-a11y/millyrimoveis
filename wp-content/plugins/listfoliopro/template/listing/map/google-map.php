<?php 
	...
	wp_enqueue_script('google-maps-api', 'https://maps.googleapis.com/maps/api/js?libraries=places&key'.esc_html($dir_map_api).'&callback=listfoliopro_initialize', array(),null, true );
...
wp_enqueue_style('listfoliopro-single-google-map', listfoliopro_ep_URLPATH . 'admin/files/css/single-google-map.css');	
wp_enqueue_script('markerclusterer',listfoliopro_ep_URLPATH . 'admin/files/js/markerclusterer.js');	
wp_enqueue_script('listfoliopro-google-map', listfoliopro_ep_URLPATH . 'admin/files/js/google-map.js');
	wp_localize_script('listfoliopro-google-map', 'listfoliopro_map_data', array(
