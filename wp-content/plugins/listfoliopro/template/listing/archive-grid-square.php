<?php
	...
	if($listfoliopro_archive_layout==""){$listfoliopro_archive_layout='archive-right-map';}
	if($listfoliopro_archive_layout=="archive-right-map"){		
		$main_cols='col-md-12 col-lg-8 col-xl-8';
	}else{
		$main_cols='col-md-12 col-lg-12 col-xl-12';
	}
	...
	if($listfoliopro_columns_iPad==""){$listfoliopro_columns_iPad='col-lg-6';}
	...
	$column_settings = $listfoliopro_columns_desktop . ' ' . $listfoliopro_columns_iPad . ' ' . $listfoliopro_columns_tab;
...
<div class="bootstrap-wrapper listfoliopro-archive-page">
	...
	<section class="">
		<div class="container-fluid" id="listfoliopro_main" >
			<!-- Search Form -->
			<div class="row" id="full_grid"> 				
				...
				<div class="<?php echo esc_html($main_cols); ?>  " id="dirpro_directories" >
					<div class="row listing-top-button-wrapper">
						...
						<div class="col-xl-9 col-lg-9 col-md-9  col-sm-6 col-6 ">							
							<div class="listing-top-layout d-flex align-items-center">
								...
								if($listfoliopro_top_sort_saved==""){$listfoliopro_top_sort_saved=$fields_top_section_all;}
								?>
									...
									if(is_array($fields_top_section_all)){
										foreach($fields_top_section_all  as $field_key => $field_value){
											if(in_array($field_key, $listfoliopro_top_sort_saved)){
												?>
												<option value="<?php echo esc_html($field_key);?>:asc">
													<?php esc_html_e('Sort By: ','listfoliopro');?><?php echo esc_html($field_value);?><?php esc_html_e(':asc','listfoliopro');?></option>
												<option value="<?php echo esc_html($field_key);?>:desc">
														<?php esc_html_e('Sort By: ','listfoliopro');?><?php echo esc_html($field_value);?><?php esc_html_e(':desc','listfoliopro');?></option>
											<?php	
											}
										}
									}	
					...
					<div class="row justify-content-center mix-container" >
						<?php
							$i=0;
							include( listfoliopro_ep_template. 'listing/archive_feature_listing-style-square.php');
							...
							?>	
							<?php
								include( listfoliopro_ep_template. 'listing/single-template/archive-grid-block-style-2-sharp.php');
							?>	
							<?php
				...
				if($listfoliopro_archive_layout=="archive-right-map"){
				?>
				<div class="col-md-12 col-lg-4 col-xl-4 col-sm-12  " id="archivemap" >
