<?php
	namespace Elementor;
	class ListfolioPro_Listing_Archive_Square_Widget extends Widget_Base {
		public function get_name() {
			return 'listfoliopro_listing_archive_square_widget';
		}
		public function get_title() {
			return esc_html__( 'Listing All Square', 'listfoliopro' );
		}
		...
		<?php
			...
			wp_enqueue_style('listfoliopro_listing_style_square', listfoliopro_ep_URLPATH . 'admin/files/css/archive-listing-grid-style-2-sharp.css');	
                ...
                <div class="container-fluid <?php echo esc_attr($listing_style); ?>" id="listfoliopro_main" >
                    ...
                    <div class="row" id="full_grid">
						...
						<?php if( $settings['result_counter'] == 'yes'){ ?>
							...
							<?php
							 $categories = listfoliopro_listing_categories();
							?>
                            <div class="row mix-container" >
								<?php
									...
									if(get_post_meta($id, 'listfoliopro_featured', true)=='featured'){
										...
										include( listfoliopro_ep_template. 'elementor/single-block/single-block-square.php');
									?>
...
Plugin::instance()->widgets_manager->register( new ListfolioPro_Listing_Archive_Square_Widget );
