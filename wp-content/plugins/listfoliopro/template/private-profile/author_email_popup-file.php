		...
		<div class="row" >
			<div class="col-md-12">
				<div class="modal-header">
					<h4 class="modal-title"><?php esc_html_e('Message','listfoliopro'); ?></h4>
				...
				<div class="modal-body">
						...
						<div class="col-md-12 col-sm-12">
							<form action="#" id="message-pop" name="candidate-message"   method="POST" >
								<div class="form-group  ">
									<label  for="Name"><?php  esc_html_e( 'Subject', 'listfoliopro' ); ?></label>
									<input  class=" form-control" id="subject" name ="subject" type="text">
								</div>
								<div class="form-group  ">
									<label  for="Name"><?php  esc_html_e( 'Email', 'listfoliopro' ); ?></label>
									<input  class=" form-control" id="email_address" name ="email_address" type="text">
								</div>
								<div class="form-group  ">
									<label  for="Name"><?php  esc_html_e( 'Phone#', 'listfoliopro' ); ?></label>
									<input  class=" form-control" id="visitorphone" name ="visitorphone" type="text">
								</div>
								<div class="form-group ">
									<label for="message" ><?php  esc_html_e( 'Message', 'listfoliopro' ); ?></label>
					...
					<div class="modal-footer">
						...
						<button type="button" class="btn btn-small-ar col-md-6 ml-2"  onclick="listfoliopro_user_message();" ><?php  esc_html_e( 'Send', 'listfoliopro' ); ?></button>
					</div>
			</div>				
		</div>	
	</div>	
