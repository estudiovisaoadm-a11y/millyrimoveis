...
<div class="bootstrap-wrapper  mb-3">
	<div class="container  listfolioproborder p-4">
		<?php
				...
				?>				
				<div class="border-bottom pb-4 mb-3 toptitle "><?php esc_html_e('User Info','listfoliopro');?></div>
				...
				<div class="row user_info">
					...
					<div class="col-md-12  ">
						...
						<div class="form-group row"  >
							<label for="text" class="col-md-4 control-label"><?php   esc_html_e('User Name','listfoliopro');?><span class="chili"></span></label>
							<div class="col-md-8">
								<input type="text"  name="iv_member_user_name" id="iv_member_user_name"  data-validation="length alphanumeric"
								data-validation-length="4-12" data-validation-error-msg="<?php   esc_html_e(' The user name has to be an alphanumeric value between 4-12 characters','listfoliopro');?>" class="form-control ctrl-textbox" placeholder="<?php  esc_html_e('Enter User Name','listfoliopro');?>"  alt="required">
							</div>
						</div>
						
						<div class="form-group row">
							<label for="email" class="col-md-4 control-label" ><?php   esc_html_e('Email Address','listfoliopro');?><span class="chili"></span></label>
							<div class="col-md-8">
								<input type="email" name="iv_member_email" id="iv_member_email" data-validation="email"  class="form-control ctrl-textbox" placeholder="<?php   esc_html_e('Enter email address','listfoliopro');?>" data-validation-error-msg="<?php   esc_html_e('Please enter a valid email address','listfoliopro');?> " >
							</div>
						</div>
						
						<?php wp_nonce_field( 'signup1' ); ?>
						<div class="form-group row ">
							<label for="text" class="col-md-4 control-label"><?php   esc_html_e('Password','listfoliopro');?><span class="chili"></span></label>
							<div class="col-md-8">
								...
								data-validation-strength="2" data-validation-error-msg="<?php   esc_html_e('The password is not strong enough','listfoliopro');?>">
							</div>
						</div>
							...
							?>
							<div class="form-group row ">
								<label for="text" class="col-md-4 control-label"><?php  esc_html_e('Profile Image','listfoliopro');?></label>
								<div class="col-md-8">
									<input type="file" name="profilepicture"  id="profilepicture" size="25" data-validation="required" alt="required"  data-validation-error-msg="<?php   esc_html_e('Please Add Profile Image','listfoliopro');?> " class="form-input " />
								</div>
							</div>
							<?php
							}
