...
<?php
	global $wpdb;			
	$email_body = get_option( 'listfoliopro_signup_email');
	$signup_email_subject = get_option( 'listfoliopro_signup_email_subject');
	...
	if(get_option('listfoliopro_mailchimp_api_key')!=""){
		$firstname='';
		$lastname='';
		$words= array();
		...
		$list_id=get_option('listfoliopro_mailchimp_list');
