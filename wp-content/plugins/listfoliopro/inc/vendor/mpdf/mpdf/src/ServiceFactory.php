...
class ServiceFactory
{
	...
	public function getServices(
		...
		$cache = new Cache($cacheBasePath, $config['cachelistfolioproInterval']);
		$fontCache = new FontCache(new Cache($cacheBasePath . '/ttfontdata', $config['cachelistfolioproInterval']));
