...
var dirs =JSON.parse(listfoliopro_map_data.dirs_json);
var top_image = listfoliopro_map_data.top_image;
var infotitle = listfoliopro_map_data.infotitle;
var infolocation = listfoliopro_map_data.infolocation;
var indirection = listfoliopro_map_data.indirection;
var direction_text= listfoliopro_map_data.direction_text;
var infolinkdetail= listfoliopro_map_data.infolinkdetail;

function listfoliopro_initialize() {
	var center = new google.maps.LatLng(listfoliopro_map_data.ins_lat, listfoliopro_map_data.ins_lng);
	var map = new google.maps.Map(document.getElementById('map'), {
		zoom: parseInt(listfoliopro_map_data.dir_map_zoom),
		center: center,
...
function listfoliopro_cs_toggle_street_view(btn) {
	"use strict";
...
google.maps.event.addDomListener(window, 'load', listfoliopro_initialize);
