<?php
	...
	wp_enqueue_style('font-awesome', listfoliopro_ep_URLPATH . 'admin/files/css/font-awesome/css/font-awesome.min.css');
?>
<?php
	 include('header.php');
?>
<div class="card col-md-12 col-lg-6 ">
			<div class="card-body">
		<div class="row">
			<div class="col-md-12"><h3 class="page-header"><?php esc_html_e( 'Update Package / Membership Level', 'listfoliopro' );?><br /><small> &nbsp;</small> </h3>
			</div>
		</div>				
		<form id="package_form_iv" name="package_form_iv" class="form-horizontal" role="form" onsubmit="return false;">
			...
			<div class="form-group row">
				<label for="text" class="col-md-2 control-label"><?php esc_html_e( 'Package Name', 'listfoliopro' );?></label>
				<div class="col-md-6">
			...
			<div class="form-group row">
				<label for="text" class="col-md-2 control-label"><?php esc_html_e('Sub Title','listfoliopro'); ?></label>
				<div class="col-md-6">
					<input type="text" class="form-control"
					name="package_subtile" id="package_subtile" value="<?php echo esc_attr(get_post_meta($package_id, 'package_subtitle', true)); ?>" placeholder="<?php esc_html_e('Enter Package Subtitle','listfoliopro'); ?>">
				</div>
			</div>
			<div class="form-group row">
				<label for="text" class="col-md-2 control-label"><?php esc_html_e('Is it Feature Package ?','listfoliopro'); ?></label>
				<div class="col-md-6">
			...
			<div class="form-group row">
				<label for="text" class="col-md-2 control-label"><?php esc_html_e('Package Feature List','listfoliopro'); ?></label>
			</div>	
			<div class="form-group row">
				...
				<?php	$aw=0;
					for($i=0;$i<20;$i++){
						...
						<div class=" row mb-2 " id="feature_<?php echo esc_html($i);?>" >							
							...
							<div class="col-md-1">
								<button type="button" onclick="listfoliopro_delete_feature_field(<?php echo esc_html($i);?>);"  class="btn btn-xs btn-danger"><?php esc_html_e('X','listfoliopro'); ?></button>
							</div>
			...
			<div class=" row  "  id="pac_feature">
				...
				<div class="col-md-4">
					<select class="feature_icon form-control" id="feature_icon" name="feature_icon[]">
						<option value="fa-calendar-check-o ">&#xf274; <?php esc_html_e('fa-calendar-check-o', 'listfoliopro'); ?> </option>
						<option value="fa-file-video-o">&#xf1c8; <?php esc_html_e('fa-file-video-o', 'listfoliopro'); ?></option>
						<option value="fa-newspaper-o">&#xf1ea; <?php esc_html_e('fa-newspaper-o', 'listfoliopro'); ?></option>
						<option value="fa-user-o">&#xf2c0; <?php esc_html_e('fa-user-o', 'listfoliopro'); ?></option>
						<option value="fa-envira">&#xf299; <?php esc_html_e('fa-envira', 'listfoliopro'); ?></option>
						<option value="fa-align-left">&#xf036; <span class="fa fa-align-left"></span></option>
						<option value="fa-align-right">&#xf038; <?php esc_html_e('fa-align-right', 'listfoliopro'); ?></option>
						<option value="fa-amazon">&#xf270; <?php esc_html_e('fa-amazon', 'listfoliopro'); ?></option>
						<option value="fa-ambulance">&#xf0f9; <?php esc_html_e('fa-ambulance', 'listfoliopro'); ?></option>
						<option value="fa-anchor">&#xf13d; <?php esc_html_e('fa-anchor', 'listfoliopro'); ?></option>
						<option value="fa-android">&#xf17b; <?php esc_html_e('fa-android', 'listfoliopro'); ?></option>
						<option value="fa-angellist">&#xf209; <?php esc_html_e('fa-angellist', 'listfoliopro'); ?></option>
						<option value="fa-angle-double-down">&#xf103; <?php esc_html_e('fa-angle-double-down', 'listfoliopro'); ?></option>
						<option value="fa-angle-double-left">&#xf100; <?php esc_html_e('fa-angle-double-left', 'listfoliopro'); ?></option>
						<option value="fa-angle-double-right">&#xf101; <?php esc_html_e('fa-angle-double-right', 'listfoliopro'); ?></option>
						<option value="fa-angle-double-up">&#xf102; <?php esc_html_e('fa-angle-double-up', 'listfoliopro'); ?></option>
						<option value="fa-angle-left">&#xf104; <?php esc_html_e('fa-angle-left', 'listfoliopro'); ?></option>
						<option value="fa-angle-right">&#xf105; <?php esc_html_e('fa-angle-right', 'listfoliopro'); ?></option>
						<option value="fa-angle-up">&#xf106; <?php esc_html_e('fa-angle-up', 'listfoliopro'); ?></option>
						<option value="fa-apple">&#xf179; <?php esc_html_e('fa-apple', 'listfoliopro'); ?></option>
						<option value="fa-archive">&#xf187; <?php esc_html_e('fa-archive', 'listfoliopro'); ?></option>
						<option value="fa-area-chart">&#xf1fe; <?php esc_html_e('fa-area-chart', 'listfoliopro'); ?></option>
						<option value="fa-arrow-circle-down">&#xf0ab; <?php esc_html_e('fa-arrow-circle-down', 'listfoliopro'); ?></option>
						<option value="fa-arrow-circle-left">&#xf0a8; <?php esc_html_e('fa-arrow-circle-left', 'listfoliopro'); ?></option>
						<option value="fa-arrow-circle-o-down">&#xf01a;
						<?php esc_html_e('fa-arrow-circle-o-down', 'listfoliopro'); ?></option>
						<option value="fa-arrow-circle-o-left">&#xf190; <?php esc_html_e('fa-arrow-circle-o-left', 'listfoliopro'); ?></option>
						<option value="fa-arrow-circle-o-right">&#xf18e; <?php esc_html_e('fa-arrow-circle-o-right', 'listfoliopro'); ?></option>
						<option value="fa-arrow-circle-o-up">&#xf01b; <?php esc_html_e('fa-arrow-circle-o-up', 'listfoliopro'); ?></option>
						<option value="fa-arrow-circle-right">&#xf0a9; <?php esc_html_e('fa-arrow-circle-right', 'listfoliopro'); ?></option>
						<option value="fa-arrow-circle-up">&#xf0aa; <?php esc_html_e('fa-arrow-circle-up', 'listfoliopro'); ?></option>
						<option value="fa-arrow-down">&#xf063; <?php esc_html_e('fa-arrow-down', 'listfoliopro'); ?></option>
						<option value="fa-arrow-left">&#xf060; <?php esc_html_e('fa-arrow-left', 'listfoliopro'); ?></option>
						<option value="fa-arrow-right">&#xf061; <?php esc_html_e('fa-arrow-left', 'listfoliopro'); ?></option>
						<option value="fa-arrow-up">&#xf062; <?php esc_html_e('fa-arrow-up', 'listfoliopro'); ?></option>
						<option value="fa-arrows">&#xf047; <?php esc_html_e('fa-arrows', 'listfoliopro'); ?></option>
						<option value="fa-arrows-alt">&#xf0b2; <?php esc_html_e('fa-arrows-alt', 'listfoliopro'); ?></option>
						<option value="fa-arrows-h">&#xf07e; <?php esc_html_e('fa-arrows-h', 'listfoliopro'); ?></option>
						<option value="fa-arrows-v">&#xf07d; <?php esc_html_e(' fa-arrows-v', 'listfoliopro'); ?></option>
						<option value="fa-asterisk">&#xf069; <?php esc_html_e('fa-asterisk', 'listfoliopro'); ?></option>
						<option value="fa-at">&#xf1fa; <?php esc_html_e('fa-at', 'listfoliopro'); ?></option>
						<option value="fa-automobile">&#xf1b9; <?php esc_html_e('fa-automobile', 'listfoliopro'); ?></option>
						<option value="fa-backward">&#xf04a; <?php esc_html_e('fa-backward', 'listfoliopro'); ?></option>
						<option value="fa-balance-scale">&#xf24e; <?php esc_html_e('fa-balance-scale', 'listfoliopro'); ?></option>
						<option value="fa-ban">&#xf05e; <?php esc_html_e('fa-ban', 'listfoliopro'); ?></option>
						<option value="fa-bank">&#xf19c; <?php esc_html_e('fa-bank', 'listfoliopro'); ?></option>
						<option value="fa-bar-chart">&#xf080; <?php esc_html_e('fa-bar-chart', 'listfoliopro'); ?></option>
						<option value="fa-bar-chart-o">&#xf080; <?php esc_html_e('fa-bar-chart-o', 'listfoliopro'); ?></option>
						<option value="fa-battery-full">&#xf240; <?php esc_html_e('fa-battery-full', 'listfoliopro'); ?></option>
						<option  value="fa-beer">&#xf0fc; <?php esc_html_e('fa-beer', 'listfoliopro'); ?></option>
						<option value="fa-behance">&#xf1b4; <?php esc_html_e('fa-behance', 'listfoliopro'); ?></option>
						<option value="fa-behance-square">&#xf1b5; <?php esc_html_e('fa-behance-square', 'listfoliopro'); ?></option>
						<option value="fa-bell">&#xf0f3; <?php esc_html_e('fa-bell', 'listfoliopro'); ?></option>
						<option value="fa-bell-o">&#xf0a2; <?php esc_html_e('fa-bell-o', 'listfoliopro'); ?></option>
						<option value="fa-bell-slash">&#xf1f6; <?php esc_html_e('fa-bell-slash', 'listfoliopro'); ?></option>
						<option value="fa-bell-slash-o">&#xf1f7; <?php esc_html_e('fa-bell-slash-o', 'listfoliopro'); ?></option>
						<option value="fa-bicycle">&#xf206; <?php esc_html_e('fa-bicycle', 'listfoliopro'); ?></option>
						<option value="fa-binoculars">&#xf1e5; <?php esc_html_e('fa-binoculars', 'listfoliopro'); ?></option>
						<option value="fa-birthday-cake">&#xf1fd; <?php esc_html_e('fa-birthday-cake', 'listfoliopro'); ?></option>
						<option value="fa-bitbucket">&#xf171; <?php esc_html_e('fa-bitbucket', 'listfoliopro'); ?></option>
						<option value="fa-bitbucket-square">&#xf172; <?php esc_html_e('fa-bitbucket-square', 'listfoliopro'); ?></option>
						<option value="fa-bitcoin">&#xf15a; <?php esc_html_e('fa-bitcoin', 'listfoliopro'); ?></option>
						<option value="fa-black-tie">&#xf27e; <?php esc_html_e('fa-black-tie', 'listfoliopro'); ?></option>
						<option value="fa-bold">&#xf032; <?php esc_html_e('fa-bold', 'listfoliopro'); ?></option>
						<option value="fa-bolt">&#xf0e7; <?php esc_html_e('fa-bolt', 'listfoliopro'); ?></option>
						<option value="fa-bomb">&#xf1e2; <?php esc_html_e('fa-bomb', 'listfoliopro'); ?></option>
						<option value="fa-book">&#xf02d; <?php esc_html_e('fa-book', 'listfoliopro'); ?></option>
						<option value="fa-bookmark">&#xf02e; <?php esc_html_e('fa-bookmark', 'listfoliopro'); ?></option>
						<option value="fa-bookmark-o">&#xf097; <?php esc_html_e('fa-bookmark-o', 'listfoliopro'); ?></option>
						<option value="fa-briefcase">&#xf0b1; <?php esc_html_e('fa-briefcase', 'listfoliopro'); ?></option>
						<option value="fa-btc">&#xf15a; <?php esc_html_e('fa-btc', 'listfoliopro'); ?></option>
						<option value="fa-bug">&#xf188; <?php esc_html_e('fa-bug', 'listfoliopro'); ?></option>
						<option value="fa-building">&#xf1ad; <?php esc_html_e('fa-building', 'listfoliopro'); ?></option>
						<option value="fa-building-o">&#xf0f7; <?php esc_html_e('fa-building-o', 'listfoliopro'); ?></option>
				...
				<div class="col-md-6">
				<input type="text" class="form-control" id="package_feature[]" name="package_feature[]" placeholder="<?php esc_attr_e('Enter Feature','listfoliopro'); ?>">					
				</div>
			...
			<div class="form-group row">
				<label for="text" class="col-md-2 control-label"></label>
				<div class="col-md-8 ">					
						<button type="button" onclick="listfoliopro_add_feature_field();"  class="btn btn-primary btn-sm"><?php esc_html_e('Add More Feature','listfoliopro'); ?></button>
					
				</div>
			</div>
			<div class="form-group row">
				<label for="text" class="col-md-2 control-label"> <?php esc_html_e('Order','listfoliopro'); ?> </label>
				<div class="col-md-6 ">
					<label>
						<input type="text" class="form-control" id="package_order" name="package_order"  value="<?php echo esc_attr(get_post_meta($package_id, 'listfoliopro_display_order', true)); ?>" placeholder="<?php esc_attr_e('Enter order number e.g. 1','listfoliopro'); ?>">
					</label>
				</div>
			</div>
			
			<h3 class="page-header"> <?php esc_html_e('Access Control','listfoliopro'); ?></h3>
				
			<div class="form-group row">
				<label for="text" class="col-md-2 control-label"> <?php esc_html_e('Listing Limit (Max listing post for the package)','listfoliopro'); ?></label>
				<div class="col-md-6 ">
					<label>
						<input type="text" class="form-control" id="max_pst_no" value="<?php echo esc_attr(get_post_meta($package_id, 'listfoliopro_package_max_post_no', true)); ?>"   name="max_pst_no"  placeholder="<?php esc_html_e('Enter only number e.g. 1','listfoliopro'); ?>">
					</label>
				</div>
			</div>
			
			<div class="form-group row">
				<label for="text" class="col-md-2 control-label"> <?php  esc_html_e('listing post will be feature. It will appear on top ','listfoliopro'); ?> </label>
				<div class="col-md-6 ">
					<label>
						<input type="checkbox" name="listing_feature" id="listing_feature"  class="mr-2" value='yes' <?php echo (get_post_meta($package_id, 'listfoliopro_package_feature', true)=='yes'?'checked': ''); ?>> <?php  esc_html_e(' Will Add On Featured List (show on top)','listfoliopro'); ?>
					</label>								 										
				</div>																
			</div>
			...
			<h3 class="page-header"> <?php esc_html_e( 'Billing Details', 'listfoliopro' );?></h3>
			<div class="form-group row">
				<label for="inputEmail3" class="col-md-2 control-label"><?php esc_html_e( 'Initial Payment', 'listfoliopro' );?></label>
				<div class="col-md-6">
					<input type="text" class="form-control" id="package_cost" name="package_cost" value="<?php echo esc_attr(get_post_meta($package_id, 'listfoliopro_package_cost', true)); ?>"  ><?php esc_html_e( 'The Initial Amount Collected at User Registration.', 'listfoliopro' );?>
				</div>
			</div>
			<div class="form-group row">
				<label for="text" class="col-md-2 control-label"><?php esc_html_e( 'Package Expire After', 'listfoliopro' );?></label>
				<div class="col-md-2">
					<select id="package_initial_expire_interval" name="package_initial_expire_interval" class="ctrl-combobox form-control">
						<?php
							$package_initial_period_interval= get_post_meta($package_id, 'listfoliopro_package_initial_expire_interval', true); 
				...
				<div class="col-md-4">
					<?php
						$package_initial_expire_type= get_post_meta($package_id, 'listfoliopro_package_initial_expire_type', true); 
					?>
					<select name="package_initial_expire_type" id ="package_initial_expire_type" class=" form-control">			
						<option value=""><?php esc_html_e( 'None', 'listfoliopro' );?> </option>								
						<option value="day" <?php echo ($package_initial_expire_type == 'day' ? 'selected' : '') ?>><?php esc_html_e( 'Day(s)', 'listfoliopro' );?></option>
						<option value="week" <?php echo ($package_initial_expire_type == 'week' ? 'selected' : '') ?>><?php esc_html_e( 'Week(s)', 'listfoliopro' );?></option>
						<option value="month" <?php echo ($package_initial_expire_type == 'month' ? 'selected' : '') ?>><?php esc_html_e( 'Month(s)', 'listfoliopro' );?></option>
						<option value="year" <?php echo ($package_initial_expire_type == 'year' ? 'selected' : '') ?>><?php esc_html_e( 'Year(s)', 'listfoliopro' );?></option>
					</select>		
				</div>
				<div class='col-md-12'><label for="text" class="col-md-2 control-label"></label>
					<?php esc_html_e( 'If select none then user  package will expire after 19 years. Package Expire Option will not work on Recurring Subscription. "Billing Cycle Limit" will Work For Recurring Subscription.', 'listfoliopro' );?>
				</div>
			</div>
			<div class="form-group row">
				<label for="text" class="col-md-2 control-label"> <?php esc_html_e( 'Recurring Subscription', 'listfoliopro' );?></label>
				<div class="col-md-6 ">
					<label>
						<input type="checkbox"  <?php echo (get_post_meta($package_id, 'listfoliopro_package_recurring', true)=='on'?'checked': ''); ?> name="package_recurring" id="package_recurring" value="on" > <?php esc_html_e( 'Enable Recurring Payment', 'listfoliopro' );?>
					</label>
				</div>								
			</div>
			<div id="recurring_block" style="display:<?php echo (get_post_meta($package_id, 'listfoliopro_package_recurring', true)=='on'?'': 'none'); ?>" >		  
				
				<div class="form-group row">
					<label for="text" class="col-md-2 control-label"><?php esc_html_e( 'Billing Amount', 'listfoliopro' );?></label>
					<div class="col-md-2">
						<input type="text" class="form-control" value="<?php echo esc_attr(get_post_meta($package_id, 'listfoliopro_package_recurring_cost_initial', true)); ?>" name ="package_recurring_cost_initial" id="package_recurring_cost_initial" >
					</div>
					<label for="text" class="col-md-1 control-label"><?php esc_html_e( 'Per', 'listfoliopro' );?></label>
					<div class="col-md-3">									
						<input type="text" class="form-control" value="<?php echo esc_attr(get_post_meta($package_id, 'listfoliopro_package_recurring_cycle_count', true)); ?>" id="package_recurring_cycle_count" name="package_recurring_cycle_count" placeholder="<?php esc_html_e( 'Cycle #', 'listfoliopro' );?>">
					</div>
					<div class="col-md-4">
						<?php $package_recurring_cycle_type= get_post_meta($package_id, 'listfoliopro_package_recurring_cycle_type', true); ?>
						<select name="package_recurring_cycle_type" id ="package_recurring_cycle_type" class="form-control">											
							<option value="day" <?php echo ($package_recurring_cycle_type == 'day' ? 'selected' : '') ?>> <?php esc_html_e( 'Day(s)', 'listfoliopro' );?></option>
							<option value="week" <?php echo ($package_recurring_cycle_type == 'week' ? 'selected' : '') ?>><?php esc_html_e( 'Week(s)', 'listfoliopro' );?></option>
							<option value="month" <?php echo ($package_recurring_cycle_type == 'month' ? 'selected' : '') ?>><?php esc_html_e( 'Month(s)', 'listfoliopro' );?></option>
							<option value="year" <?php echo ($package_recurring_cycle_type == 'year' ? 'selected' : '') ?>><?php esc_html_e( 'Year(s)', 'listfoliopro' );?></option>
						</select>		
					</div>
					<div class='col-md-12'><label for="text" class="col-md-2 control-label"></label>
						<?php esc_html_e( 'The "Billing Amount" will Collect at User Registration.', 'listfoliopro' );?>
					</div>
				</div>
				 <?php
					 if(get_option('listfoliopro_payment_gateway')!='woocommerce'){
					?>
				<div class="form-group row">
					<label for="text" class="col-md-2 control-label"><?php esc_html_e( 'Billing Cycle Limit', 'listfoliopro' );?></label>
					<div class="col-md-2">
						<select name="package_recurring_cycle_limit" id ="package_recurring_cycle_limit" class="ctrl-combobox form-control">	
							<option value=""><?php esc_html_e( 'Never', 'listfoliopro' );?></option>										
							<?php
								$package_recurring_cycle_limit= get_post_meta($package_id, 'listfoliopro_package_recurring_cycle_limit', true); 
								for($ii=1;$ii<35;$ii++){
				...
				<div class="form-group row">
					<label for="text" class="col-md-2 control-label"> <?php esc_html_e( 'Trial', 'listfoliopro' );?></label>
					<div class="col-md-6 ">
						<label>
							<input type="checkbox" <?php echo (get_post_meta($package_id, 'listfoliopro_package_enable_trial_period', true)=='yes'? 'checked': ''); ?> name="package_enable_trial_period" id="package_enable_trial_period" value='yes'> <?php esc_html_e( 'Enable Trial Period', 'listfoliopro' );?>
						</label>
						<br/>
						<?php esc_html_e( '"Billing Amount" will Collect After Trial Period.', 'listfoliopro' );?>   
					</div>								
				</div>
				<div id="trial_block" style="display:<?php echo (get_post_meta($package_id, 'listfoliopro_package_enable_trial_period', true)=='yes'? '': 'none'); ?>" >		  
					<div class="form-group row">
						<label for="inputEmail3" class="col-md-2 control-label"><?php esc_html_e( 'Trial Amount', 'listfoliopro' );?></label>
						<div class="col-md-6">
							<input type="text" class="form-control" value="<?php echo esc_attr(get_post_meta($package_id, 'listfoliopro_package_trial_amount', true)); ?>" id="package_trial_amount" name="package_trial_amount" >
							<?php esc_html_e( 'Amount to Bill for The Trial Period. Free is 0.[Stripe will not support this option ]', 'listfoliopro' );?>
						</div>
					</div>
					<div class="form-group row">
						<label for="text" class="col-md-2 control-label"><?php esc_html_e( 'Trial Period', 'listfoliopro' );?></label>
						<div class="col-md-2">
							<select id="package_trial_period_interval" name="package_trial_period_interval" class="ctrl-combobox form-control">
								<?php
									$package_trial_period_interval= get_post_meta($package_id, 'listfoliopro_package_trial_period_interval', true); 
									for($ii=1;$ii<31;$ii++){
						...
						<div class="col-md-4">
							<?php
								$package_recurring_trial_type= get_post_meta($package_id, 'listfoliopro_package_recurring_trial_type', true); 
							?>
							<select name="package_recurring_trial_type" id ="package_recurring_trial_type" class=" form-control">											
								<option value="day" <?php echo ($package_recurring_trial_type == 'day' ? 'selected' : '') ?>> <?php  esc_html_e('Day(s)','listfoliopro'); ?></option>
								<option value="week" <?php echo ($package_recurring_trial_type == 'week' ? 'selected' : '') ?>><?php  esc_html_e('Week(s)','listfoliopro'); ?></option>
								<option value="month" <?php echo ($package_recurring_trial_type == 'month' ? 'selected' : '') ?>><?php  esc_html_e('Month(s)','listfoliopro'); ?></option>
								<option value="year" <?php echo ($package_recurring_trial_type == 'year' ? 'selected' : '') ?>><?php  esc_html_e('Year(s)','listfoliopro'); ?></option>
							</select>		
						</div>
						<div class='col-md-12'><label for="text" class="col-md-2 control-label"></label>
							<?php esc_html_e( 'After The Trial Period "Billing Amount"	Will Be Billed.	', 'listfoliopro' );?>
						</div>
					</div>
				</div> <!-- Trial Block --> 
				<?php
...
if(get_option('listfoliopro_payment_gateway')=='woocommerce'){
	if ( class_exists( 'WooCommerce' ) ) {
		 $listfoliopro_woo_pro= get_post_meta($package_id, 'listfoliopro_package_woocommerce_product', true);
	?>  
	  <div class="form-group row">
		<label for="text" class="col-md-2 control-label"><?php esc_html_e('Woocommerce Product','listfoliopro'); ?></label>
		<div class="col-md-3">							
				<select  class="form-control" id="Woocommerce_product" name="Woocommerce_product">
					...
					if(sizeof($product_rows)>0){									
						...
						{	$selected='';
							if($listfoliopro_woo_pro==$row->ID){$selected=' selected';}												
...
?>
		...
		<div class="form-group row">
				...
				<div class="col-md-6 ">
					<p><hr></p>
					<div id="loading"></div>
					<button class="btn btn-info mt-2" onclick="return listfoliopro_update_the_package();"><?php  esc_html_e('Save Package','listfoliopro'); ?></button>
				<a href="<?php echo listfoliopro_ep_ADMINPATH; ?>admin.php?page=listfoliopro-settings&packages" class="btn btn-info mt-2" ><?php esc_html_e( '<< Back', 'listfoliopro' );?></a>
				</div>																
			</div>	
		</form>
	</div>
