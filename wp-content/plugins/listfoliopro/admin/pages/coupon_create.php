...
<div class="card col-md-12 col-lg-6  mb-3">
	<div class="card-body">
		...
		<div class="row">
			<div class="col-md-12"><h3 class="page-header"><?php esc_html_e( 'Create New Coupon ', 'listfoliopro' );?></h3>						
				</div>	
		</div> 
		<form id="coupon_form_iv" name="coupon_form_iv" onsubmit="return false;">
			...
			<div class="form-group">
				<label for="text" class="control-label"><?php esc_html_e( 'Discount Type', 'listfoliopro' );?></label>
					...
					<select  name="coupon_type" id ="coupon_type" class="form-control">
						<option value="amount" ><?php esc_html_e( 'Fixed Amount', 'listfoliopro' );?></option>
						<option value="percentage" ><?php esc_html_e( 'Percentage', 'listfoliopro' );?></option>
					</select>
				
			</div> 			
			<div class="form-group ">
				<label for="text" class=" control-label"><?php esc_html_e( 'Package Only', 'listfoliopro' );?></label>
			...
			<div class="form-group " >									
				<label for="text" class="control-label"><?php esc_html_e( 'Start Date', 'listfoliopro' );?></label>
					...
					<input type="text"  name="start_date"  readonly   id="start_date" class="form-control ctrl-textbox"  placeholder="<?php esc_attr_e( 'Select Date', 'listfoliopro' );?>">
				
			</div>							  
			<div class="form-group ">
				<label for="inputEmail3" class=" control-label"><?php esc_html_e( 'Expire Date', 'listfoliopro' );?></label>
			
					<input type="text" class="form-control" readonly id="end_date" name="end_date" value=""  placeholder="<?php esc_html_e( 'Select Date', 'listfoliopro' );?>">
				
			</div>
			<div class="form-group ">
				<label for="inputEmail3" class=" control-label"><?php esc_html_e( 'Amount', 'listfoliopro' );?></label>
			
					<input type="text" class="form-control" id="coupon_amount" name="coupon_amount" value=""  placeholder=" <?php esc_attr_e( 'Coupon number [ no currency or comma ]', 'listfoliopro' );?>">
				
			</div>	
			<div class="form-group ">
				<label for="inputEmail3" class=" control-label"></label>
				
					<button class="btn btn-info mt-2" onclick="return listfoliopro_create_coupon();"><?php esc_attr_e( 'Save Coupon', 'listfoliopro' );?></button>
