<?php
/* Template Name: MillyR - Quem Somos */
get_header(); ?>
    ...
    <div class="container">
        ...
        <div class="about-stats">
            ...
            <div class="stat-card">
                ...
                <p class="stat-label">Imóveis vendidos</p>
            </div>
            <div class="stat-card">
            ...
            <div class="stat-card">
                ...
                <p class="stat-label">Satisfação dos clientes</p>
            </div>
        </div>
...
<section class="section section-light">
    <div class="container">
        ...
        <div class="team-grid">
            <div class="team-card">
                <img src="https://images.unsplash.com/photo-1560250097-0b93528c311a" alt="Sócio Fundador">
                <h4>Ricardo Mendes</h4>
                <p>Sócio Fundador</p>
            </div>
            <div class="team-card">
                <img src="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2" alt="Diretora Comercial">
                <h4>Ana Oliveira</h4>
                <p>Diretora Comercial</p>
            </div>
            <div class="team-card">
                <img src="https://images.unsplash.com/photo-1519085360753-af0119f7cbe7" alt="Corretor Sênior">
                <h4>Carlos Silva</h4>
                <p>Corretor Sênior</p>
            </div>
            <div class="team-card">
                <img src="https://images.unsplash.com/photo-1580489944761-15a19d654956" alt="Marketing">
                <h4>Juliana Costa</h4>
