<?php
/* Template Name: MillyR - Condomínios */
get_header(); ?>
...
<section class="section page-content">
    <div class="container">
        <?php
        $condominios = new WP_Query([
            'post_type'      => 'imovel',
            'posts_per_page' => -1,
            'meta_key'       => 'condominio',
            'meta_compare'   => 'EXISTS',
        ]);
        if ($condominios->have_posts()): ?>
            <div class="properties-grid">
                <?php while ($condominios->have_posts()): $condominios->the_post();
                    ...
                    $condominio_valor = get_post_meta(get_the_ID(), 'condominio', true);
                    ?>
                    <div class="property-card">
                        ...
                        <div class="property-card-body">
                            ...
                            <div class="property-card-features">
                                ...
                                <?php if ($condominio_valor): ?><span>Cond.: R$ <?php echo number_format((float)$condominio_valor, 0, ',', '.'); ?></span><?php endif; ?>
                            </div>
                        </div>
                    </div>
        ...
        <?php else: ?>
            <p style="text-align:center;color:var(--gray-400);">Nenhum imóvel em condomínio encontrado.</p>
        <?php endif; ?>
    </div>
</section>
<?php get_footer(); ?>
